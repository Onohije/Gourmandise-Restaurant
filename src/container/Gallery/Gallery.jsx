...
const IgalleryImages = [images.gallery01, images.gallery02, images.gallery03, images.gallery04];
  ...
  return (
    <div className='app_gallery flex_center'>
      <div className='app__gallery-content'>
        <SubHeading title="Instagram" />
        <h1 className='headtext__cormorant'>Photo Gallery</h1>
        <p className='p__opensans' style={{ color: '#AAA', marginTop: '2rem'}}>A glimpse into the elegance, flavors, and memories we create every day.</p>
